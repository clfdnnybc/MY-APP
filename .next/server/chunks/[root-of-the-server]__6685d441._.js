...
async function PUT(req) {
    ...
    const [existingUserRows] = await pool.query("SELECT * FROM users WHERE username = ?", [
        username
    ]);
    const existingUser = existingUserRows[0];
    if (existingUser && existingUser.username !== storedUsername) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6685d441._.js.map